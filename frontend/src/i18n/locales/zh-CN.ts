const zhCN = {
  ...
  auth: {
    ...
    login: {
      ...
      identityEnterprise: "企业用户",
      identityPersonal: "个人用户",
      identityLinglong: "玲珑生态会员",
      enterpriseWelcome: "企业用户登录",
      linglongWelcome: "玲珑会员登录",
      enterpriseNoAccess: "当前账号无企业权限，请使用企业账号登录",
    },
    register: {
      title: "注册账号",
      ...
      sendFailed: "发送失败",
      codeCountdown: "{{count}} 秒后重新获取",
      resend: "重新发送",
      send: "发送",
    },
    linglongRegister: {
      heroTitle: "成为玲珑生态会员",
      heroSubtitle: "解锁专属供应链图库、模板库与服务窗口",
      featureSupplyChain: "专属供应链图库 · DFC分类归档",
      featureTemplate: "专属模板库 · 一键生成AI效果图",
      featureService: "人工+AI双通道服务窗口",
      featureIadu: "IADU团队协同操作支持",
      formTitle: "玲珑生态会员注册账号",
      formSubtitle: "凭邀请码加入玲珑生态专属私域",
      inviteCodePlaceholder: "邀请码 (必填)",
      namePlaceholder: "姓名 (必填)",
      companyPlaceholder: "所属公司 (必填)",
      passwordSetPlaceholder: "设置密码 (至少6位)",
      confirmPasswordPlaceholder: "确认密码",
      smsResendCountdown: "{{count}} 秒后重新获取",
      inviteRequired: "请填写邀请码",
      nameRequired: "请填写姓名",
      companyRequired: "请填写所属公司",
      submit: "注册",
      goLogin: "去登录",
      forgotPassword: "忘记密码",
    },
  ...
  workspace: {
    header: {
      ...
      referral: "推广激励",
      myCredits: "我的积分",
      memberCountWithRole: "{{count}} 人 · {{role}}",
      backHome: "返回首页",
      renameHint: "双击重命名",
      switchProject: "切换项目",
      noProjects: "暂无项目",
  ...
  enterprise: {
    home: {
      title: "TAI 企业版",
      subtitle: "企业由平台开通。您可进入已加入的企业后台，或提交邀请码申请加入。",
      myEnterprises: "我的企业",
      enterConsole: "进入后台",
      noAccess: "暂无企业权限",
      noAccessHint: "请联系 TAI 平台开通企业，或使用管理员发给您的邀请码申请加入",
      inviteTitle: "邀请码申请加入",
      invitePlaceholder: "输入邀请码或粘贴邀请链接",
      submit: "提交申请",
      submitting: "提交中…",
      successDefault: "申请已提交，请等待企业管理员审核",
      backHome: "返回首页",
    },
    login: {
      title: "企业版登录",
      ...
      submitting: "登录中…",
      backHome: "返回首页",
      invalid: "账号或密码错误，或该账号无权进入企业后台",
    },
    header: {
      console: "企业后台",
      consoleTitle: "进入企业后台",
      enterprise: "企业版",
      enterpriseTitle: "企业版入口",
      inviteCode: "邀请码",
      inviteCodeTitle: "输入企业邀请码",
      teamQuota: "团队额度",
      unlimited: "不限",
      teamQuotaHint: "当前使用团队额度，显示为你的个人可用配额",
    },
    homeActions: {
      enterprise: "企业版",
      enterpriseContact: "企业版咨询",
      enterpriseContactDesc: "企业版咨询\n客服微信",
      enterpriseContactLabel: "企业版咨询客服微信",
    },
  },
} as const;
