const zhCN = {
  ...
  home: {
    ...
    scenes: {
      ...
      items: [
        { title: "商业综合体设计", category: "architecture" },
        { title: "城市公共空间规划", category: "architecture" },
        { title: "住宅区景观设计", category: "architecture" },
        { title: "办公楼室内设计", category: "architecture" },
        { title: "零售环境布局设计", category: "architecture" },
        { title: "教学空间方案设计", category: "education" },
        { title: "职业作品集指导", category: "career" },
        { title: "设计技能实训", category: "skills" },
        { title: "在线课程场景", category: "online" },
        { title: "企业定制培训", category: "corporate" },
      ],
    },
  },
  auth: {
