...
function getDefaultConfigs(): NodeConfig[] {
  return [
    ...
    // 生图节点
    { nodeKey: "generate", nameZh: "生成节点", nameEn: "Nano banana", category: "image", status: "normal", sortOrder: 10, creditsPerCall: 20 },
    { nodeKey: "generate4", nameZh: "四图生成", nameEn: "Nano banana (4 images)", category: "image", status: "normal", sortOrder: 11, creditsPerCall: 80 },
